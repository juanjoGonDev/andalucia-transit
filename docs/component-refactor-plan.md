...
- 2025-10-17: Stubbed OpenStreetMap tile requests in the Cypress visual regression suite so map snapshots remain deterministic while maintaining zero-diff enforcement.
