...
describe('RouteTimetableService', () => {
  ...
  function setup(response: ApiRouteTimetableResponse): RouteTimetableService {
  ...
  function buildResponse(entries: ApiRouteTimetableResponse['horario']): ApiRouteTimetableResponse {
    return {
      bloques: [],
      horario: entries,
      frecuencias: [
