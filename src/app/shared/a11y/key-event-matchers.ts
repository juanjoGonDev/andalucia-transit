...
const KEY_IDENTIFIER_ARROW_LEFT = 'ArrowLeft' as const;
const KEY_IDENTIFIER_ARROW_RIGHT = 'ArrowRight' as const;
const KEY_IDENTIFIER_LEFT = 'Left' as const;
const KEY_IDENTIFIER_RIGHT = 'Right' as const;
...
export const ARROW_LEFT_KEY_MATCHER: KeyMatcher = createKeyMatcher({
  ...
  keyIdentifiers: [KEY_IDENTIFIER_ARROW_LEFT, KEY_IDENTIFIER_LEFT]
});
...
export const ARROW_RIGHT_KEY_MATCHER: KeyMatcher = createKeyMatcher({
  ...
  keyIdentifiers: [KEY_IDENTIFIER_ARROW_RIGHT, KEY_IDENTIFIER_RIGHT]
});
